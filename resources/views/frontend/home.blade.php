          ...
          <div class="col-md-9">
              ...
              <div class="row">
                  <div class="col-md-6 col-lg-6 ftco-animate">
                          <div class="blog-entry">
                              <div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url({{ asset('img/bg/blog-0.jpg') }});">
                                  <div class="overlay"></div>
                                  <div class="text">
                                      <span class="subheading">Food</span>
                      ...
                      <div class="col-md-6 col-lg-6 ftco-animate">
                          <div class="blog-entry">
                              <div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url({{ asset('img/bg/blog-1.jpg') }});">
                                  <div class="overlay"></div>
                                  <div class="text">
          ...
          <div class="col-md-3">
              ...
              <div class="sidebar-box categories text-center ftco-animate">
                    ...
                    <ul class="category-image">
                        <li>
                            <a href="foods.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('img/bg/foods.jpg') }});">
                                <div class="text">
                                    <h3>Foods</h3>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="lifestyle.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('img/bg/lifestyle.jpg') }});">
                                <div class="text">
                                    <h3>Lifestyle</h3>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('img/bg/others.jpg') }});">
                                <div class="text">
                                    <h3>Others</h3>
                                </div>
                            </a>
      ...
      <div class="container">
          <div class="row d-flex">
              <div class="col-md-6 d-flex">
                  <div class="img d-flex align-self-stretch" style="background-image:url({{ asset('img/bg/about.jpg') }});"></div>
              </div>
